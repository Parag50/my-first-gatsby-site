...
const AboutPage = () => {
  return (
    <Layout pageTitle="About Our Law Firm">
      ...
      <p>
        Parag Kushwah has been practicing law for over 15 years, specializing in
        family law, criminal defense, and civil litigation. She is recognized as
        one of the top attorneys in the country and has helped countless clients
        achieve justice in and out of the courtroom.
      </p>
    </Layout>
  );
};
